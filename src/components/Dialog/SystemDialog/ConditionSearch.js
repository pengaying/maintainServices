                ...
                <div className="popup_s_confirm_box">
                    <div style={{ width: '300px' }}>
                            ...
                            <div className={styles.InputStyle}>
                                <Form.Item>
                                    {getFieldDecorator('CsignalType', { initialValue: false, })(
                                        <Checkbox checked={this.props.form.getFieldValue("CsignalType")}>
                                            信息类别:
                                        </Checkbox>
                                    )}
                                </Form.Item>
                        ...
                        <div className={styles.table_content}>
                            ...
                            <div className={styles.InputStyle}>
                                <Form.Item>
                                    {getFieldDecorator('Cdate', { initialValue: false, })(
                                        <Checkbox checked={this.props.form.getFieldValue("Cdate")}>
                                            日期时间:
                                        </Checkbox>
                                    )}
                                </Form.Item>
