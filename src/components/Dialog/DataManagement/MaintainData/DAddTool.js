...
class DAddTool extends Component {
    constructor(props) {
        super();
        this.state = {
    ...
    ClickConfirm = () => {
        ...
        let data = this.props.dataManagement.DMDToolTableDataSource;//获取工具表格数据
        let datalength = this.props.dataManagement.DMDToolTableDataSource.length;//获取工具表格数据长度
        let detaildata = this.props.dataManagement.DMDToolDetailDataSource;//获取详情待修改数据
...
export default connect()(DAddTool);
