...
class Create extends Component {
  ...
  modifyTool = (param) => {
    ...
    this.props.dispatch({
      type: 'dataManagement/MDToolDetailData',
      payload: param
    })
  }
  // 点击删除 工具
  ClickDeleteTool = (key) => {
    let newData = this.props.dataManagement.MDToolTableDataSource;//获取所有工具列表数据
  ...
  modifyReplace = (param) => {
    console.log('修改===detaildata==', param)
    this.props.dispatch({
      type: 'dataManagement/MDListDetailData',
      payload: param
    })
  }
  // 点击删除 更换件
  ClickDeleteList = (key) => {
    let newData = this.props.dataManagement.MDListTableDataSource;//获取所有 更换件列表数据
    const index = newData.findIndex((item) => key === item.key);
    newData.splice(index, 1);
    console.log(newData);
    this.props.dispatch({
  ...
  ClickConfirm = () => {
    ...
    this.props.form.validateFields((err, fieldsValue) => {
      ...
      if (repairTime !== '' && repairTime !== undefined && repairTime !== null &&
        ...
        obj.rmatList = this.props.dataManagement.MDListTableDataSource;//获取所有 工具 列表数据
        obj.rspList = this.props.dataManagement.MDListTableDataSource;//获取所有 更换件 列表数据
...
Create = Form.create({
  ...
  mapPropsToFields(props) {
    ...
    if (props.DetailViewData != null && props.sign === 'detail') {
      let DetailViewData = props.DetailViewData;
      return {
        stationName: Form.createFormField({
          ...props,
          value: DetailViewData.stationName,
        }),
        stationPn: Form.createFormField({
          ...props,
          value: DetailViewData.stationPn,
        }),
        stationSn: Form.createFormField({
          ...props,
          value: DetailViewData.stationSn,
        }),
        stationBn: Form.createFormField({
          ...props,
          value: DetailViewData.stationBn,
        }),

        extensionName: Form.createFormField({
          ...props,
          value: DetailViewData.extensionName,
        }),
        extensionPn: Form.createFormField({
          ...props,
          value: DetailViewData.extensionPn,
        }),
        extensionSn: Form.createFormField({
          ...props,
          value: DetailViewData.extensionSn,
        }),
        objectName: Form.createFormField({
          ...props,
          value: DetailViewData.objectName,
        }),
        objectPn: Form.createFormField({
          ...props,
          value: DetailViewData.objectPn,
        }),
        objectSn: Form.createFormField({
          ...props,
          value: DetailViewData.objectSn,
        }),
        repairTime: Form.createFormField({
          ...props,
          value: DetailViewData.repairTime,
        }),
        endTime: Form.createFormField({
          ...props,
          value: DetailViewData.endTime,
        }),
        repairLevel: Form.createFormField({
          ...props,
          value: DetailViewData.repairLevel,
        }),
        repairPerson: Form.createFormField({
          ...props,
          value: DetailViewData.repairPerson,
        }),
        repairState: Form.createFormField({
          ...props,
          value: DetailViewData.repairState,
        }),
        repairResult: Form.createFormField({
          ...props,
          value: DetailViewData.repairResult,
        }),
        fPhenomenon: Form.createFormField({
          ...props,
          value: DetailViewData.fPhenomenon,
        }),
        fReason: Form.createFormField({
          ...props,
          value: DetailViewData.fReason,
        }),
        method: Form.createFormField({
          ...props,
          value: DetailViewData.method,
        }),
        summary: Form.createFormField({
          ...props,
          value: DetailViewData.summary,
        }),
      };
    }
  }
