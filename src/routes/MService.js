...
import MaintainService from '../components/MaintainService';
...
import MainTenan from './../components/Guide/MainTenan';

export default class MService extends Component {
  constructor() {
    super();
    this.state = {
            ...
            <ul>
              ...
              <Link to="/mservice">
                <li style={{ background: ServicebgColor }}>
                  <div id="mservice" onClick={this.changeColor}>
                    维修指导
                  </div>
                </li>
              </Link>
