...
export default class Map extends PureComponent {
  ...
  get menus () {
    ...
    return [
      { key: 'save', icon: 'save', title: '保存', handleClick: this.openJB },
      { key: 'close', icon: 'close', title: '关闭', handleClick: this.openJB },
      { key: 'location', icon: 'location', title: '定位', handleClick: this.openJB },
      { key: 'roam', icon: 'roam', title: '漫游', handleClick: this.handleRoam },
      { key: 'open', icon: 'open', title: '打开', handleClick: this.openJB },
      ...
      { key: 'flag', icon: 'flag', title: '军标', handleClick: this.openJB },
      { key: 'global', icon: 'global', title: '全球', handleClick: this.openJB },
      { key: 'airplane', icon: 'airplane', title: '飞机', handleClick: this.openJB },
      { key: 'setting', icon: 'setting', title: '设置', handleClick: this.openJB },
